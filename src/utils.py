...
def calculate_metrics(predictions, labels, log_images=False):
    ...
    metrics["f2"] = fbeta_score(core_labels, core_probs > best_threshold, beta=2)
    metrics["f5"] = fbeta_score(core_labels, core_probs > best_threshold, beta=5)
    metrics["f8"] = fbeta_score(core_labels, core_probs > best_threshold, beta=8)
    metrics["balanced_accuracy"] = balanced_accuracy_score(core_labels, core_probs > best_threshold)
